...
function AddEntryScreen(){
    ...
    async function handleSubmit(e){
        ...
        if(condition){
            ...
            if(!updateMode){
                axios.post("http://127.0.0.1:8080/api/v1/entries/addEntry", data, { headers: { Authorization: `Bearer ${user.accessToken}` } })
                .then((result)=>{
                ...
                axios.put("http://127.0.0.1:8080/api/v1/entries/edit/"+location.state._id, data, { headers: { Authorization: `Bearer ${user.accessToken}` } })
                .then((result)=>{
